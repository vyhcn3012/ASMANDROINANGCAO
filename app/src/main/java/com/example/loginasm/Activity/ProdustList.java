...
public class ProdustList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.produst_list_activity);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(ProdustList.this);
...
//                            // show dialog update at here
                            showDialogUpdate(ProdustList.this, arrID.get(position));
    ...
    private void showDialogDelete(final int idProdus){
        final AlertDialog.Builder dialogDelete = new AlertDialog.Builder(ProdustList.this);
